...
const barbers = [
  {
    ...
    rating: "5.0",
    specialties: "Стрижка — это сочетание мастерства, точности и внимания к деталям. За более чем семь лет работы я сформировал подход, в котором важен не только результат, но и комфорт каждого гостя. Работая с современными и классическими техниками, я создаю образ, который подчеркивает индивидуальность и соответствует вашему стилю жизни. Каждая стрижка выполняется с максимальной аккуратностью, а оформление бороды становится завершающим штрихом, создающим гармоничный образ. Моя цель — чтобы каждый гость покидал кресло с уверенностью в своем внешнем виде и желанием вернуться снова. Добро пожаловать в BURAN BARBERSHOP — место, где качество, стиль и сервис становятся единым стандартом"
  },
  // {
  //   id: 2,
  //   name: "Максим",
